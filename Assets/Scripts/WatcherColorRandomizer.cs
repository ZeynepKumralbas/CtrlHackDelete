...
{
    public class WatcherColorRandomizer : MonoBehaviourPun
    {
        ...
        [SerializeField] private string materialNameToModify = "WatcherMaterial"; // Material name
        ...
        private void OrganizeRobotParts()
        {
            ...
            foreach (Transform part in parent)
            {
                ...
                else if (partName.Contains("arms")) arms.Add(part.gameObject);
                else if (partName.Contains("legs")) legs.Add(part.gameObject);
        ...
        private void RandomizeMaterialOffsets()
        {
            ...
            ApplyMaterialOffsets(randomX, randomY);
        }
